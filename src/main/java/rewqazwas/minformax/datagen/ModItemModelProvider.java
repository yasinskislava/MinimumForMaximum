...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        basicItem(ModItems.ULTIMATE_SPEED_UPGRADE.get());
        basicItem(ModItems.PROCESSING_UPGRADE_TIER1.get());
        basicItem(ModItems.PROCESSING_UPGRADE_TIER2.get());
        basicItem(ModItems.PROCESSING_UPGRADE_TIER3.get());
        basicItem(ModItems.PROCESSING_UPGRADE_TIER4.get());
        basicItem(ModItems.ULTIMATE_PROCESSING_UPGRADE.get());
        ...
        basicItem(ModItems.FORTUNE_UPGRADE_TIER1.get());
        basicItem(ModItems.FORTUNE_UPGRADE_TIER2.get());
        basicItem(ModItems.FORTUNE_UPGRADE_TIER3.get());
        basicItem(ModItems.FORTUNE_UPGRADE_TIER4.get());
        basicItem(ModItems.AUTO_SMELTING_UPGRADE.get());
        basicItem(ModItems.WATERING_UPGRADE.get());
